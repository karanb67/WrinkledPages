...
<body>
	<div class="container">
		<div class="left_container">
			...
			<div class="buttons">
				<a href="pdfs/scifi/The Moon Is a Harsh Mistress.pdf" class="button" target="_blank">Read Book</a><br><br><br>
				<a href="#" download="pdfs/scifi/The Moon Is a Harsh Mistress.pdf" class="button">Download</a>
			</div>
			<div class="genre">
				Genre:
			...
			<div class="leftdown">
				...
				<p> So we have AI, use of food as a weapon of war, philosophy, how probability influences human decisions and satirizing statistics<br><br>
				A radically forward-thinking visionary of libertarianism		<br><br>
				Any point on the sociopolitical spectrum in between.		<br><br>
				</p>
			</div>
		</div>
